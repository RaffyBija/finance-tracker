...
export const TOUR_STEPS: TourStep[] = [
  ...
  },
  {
    ...
    title: 'Navigazione',
    content: 'Dashboard, Transazioni, Budget e Calendario sono le sezioni principali. In "Gestione" trovi Conti, Categorie, Ricorrenti e Pianificati.',
    position: 'top',
  },
  {
    id: 'accounts',
    target: '[data-tour="gestione-btn"]',
