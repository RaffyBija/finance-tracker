  ...
  },
  {
    ...
    content: (
      <>
        ...
        <p><strong>Promemoria «Scadenze da registrare»</strong> — al primo accesso della giornata un unico popup raccoglie tutto ciò che è in scadenza oggi o arretrato: <strong>ricorrenti, pianificate, rate e addebiti della carta</strong>. Se il movimento è già avvenuto (es. un <strong>addebito diretto</strong> sul conto) lo registri in un tocco, senza inserirlo a mano. Ogni voce usa la sua <strong>data prevista</strong>; se il pagamento è arrivato in un altro giorno, <strong>tocca la data</strong> per correggerla. «Salta oggi» lo rimanda a domani: nel frattempo il badge nel menu resta visibile.</p>
