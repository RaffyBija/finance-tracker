...
export const dashboardAPI = {
  ...
  getNetWorthByAccount: async (params: { months?: number }): Promise<NetWorthByAccountSeries> => {
    const { data } = await api.get<NetWorthByAccountSeries>('/dashboard/networth-by-account', { params });
    return data;
  },
